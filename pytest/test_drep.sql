...
db.getCollection("TestCase").insert([ {
    ...
    TestID: NumberInt("1"),
    Launch: "0xd6e1b15eDDd2e93FE48e62583FD32C22044e7B6f",
    Receive: "0xd3EE25DB3F3eb7b266c347f97504f442ADb91846",
    money: NumberInt("300000"),
    gaslimt: NumberInt("18000000"),
    gasprice: NumberInt("273")
} ]);
...
db.getCollection("result_msg").insert([ {
    ...
    time: "2020-06-19 19:07:26"
} ]);
db.getCollection("result_msg").insert([ {
    _id: ObjectId("5eec9d75c80ccfb0a65de848"),
    method: "chain_getBalance",
    result: "999999802841356000000000",
    time: "2020-06-19 19:12:09"
} ]);
db.getCollection("result_msg").insert([ {
    _id: ObjectId("5eecbeaef6d8a5a46d081f7c"),
    method: "account_voteCredit",
    result: "0xa507771b0fe3616b5dae5b2001022a25e86966d410c5f151890a29793921457b",
    time: "2020-06-19 22:37:13"
} ]);
db.getCollection("result_msg").insert([ {
...
db.getCollection("result_msg").insert([ {
    ...
    method: "chain_getCandidateAddrs",
    result: "[{\"Addr\":\"0x3726430e6e3448753f29e1d3ca24120850433ff9\",\"Credit\":\"0x1bc16d674ec93312\"},{\"Addr\":\"0x6c09dc42420b79b1222bd62d964e9e2dccc558ea\",\"Credit\":\"0xa\"},{\"Addr\":\"0x16838cc5b6d97b43874421dcc123ba31f13e9725\",\"Credit\":\"0xa\"},{\"Addr\":\"0xb490ffa71d9d1d9f4472fbc46ee6e4ffd2bb486b\",\"Credit\":\"0x1a784379d99db42000000\"}]",
    time: "2020-06-19 22:37:18"
} ]);
db.getCollection("result_msg").insert([ {
        ...
        [
            {
                Data: {
                    Version: NumberInt("1"),
                    Nonce: NumberInt("7019"),
                    Type: NumberInt("4"),
                    To: "0xd3ee25db3f3eb7b266c347f97504f442adb91846",
                    ChainId: NumberInt("0"),
                    Amount: "0x493e0",
                    GasPrice: "0x111",
                    GasLimit: "0x112a880",
                    Timestamp: NumberInt("1592577432"),
                    Data: null
                },
                Sig: "HzzLojYvkvPJoaVrAJeYbAlIb6/vCS7Jrn4Yjj655lS7a6TCK4vYQQEWl1WTRJaCP4LIDDxqrXb4dsRXymzcKCw="
            },
            {
                Data: {
                    Version: NumberInt("1"),
                    Nonce: NumberInt("7020"),
                    Type: NumberInt("5"),
                    To: "0xd3ee25db3f3eb7b266c347f97504f442adb91846",
                    ChainId: NumberInt("0"),
                    Amount: "0x493e0",
                    GasPrice: "0x493e0",
                    GasLimit: "0x112a880",
                    Timestamp: NumberInt("1592577438"),
                    Data: null
                },
                Sig: "H4zBImNcJFkUQIbXXUNOFDOC4rnLPKtNvTqcdaNwchOuIj/28Q4Vmclt/1rNb4ed+2W4qy3s5flBvRkm65KO2Wk="
            }
        ]
    ],
    time: "2020-06-19 22:37:18"
...
db.getCollection("result_msg").insert([ {
    ...
    method: "account_dumpPubkey",
    result: "0x02ff36487d10917845df38bdf3f4b234f435535b50c90c0fa9016ff29a07e10f45",
    time: "2020-06-19 22:45:35"
} ]);
db.getCollection("result_msg").insert([ {
...
db.getCollection("result_msg").insert([ {
    ...
    method: "account_cancelCandidateCredit",
    result: "0x26bef3c179c3c0221a3b9455a52962002ef17844a4ed6ea72fdc38111a9893de",
    time: "2020-06-19 22:45:39"
} ]);
